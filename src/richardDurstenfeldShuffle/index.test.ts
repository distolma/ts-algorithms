import { richardDurstenfeldShuffle } from "./index";

describe('richardDurstenfeldShuffle', () => {
  ...
  it('should return shuffeled array of numbers', () => {
    ...
    const result = richardDurstenfeldShuffle(numberArray);
  ...
  it('should return shuffeled array of strings', () => {
    const result = richardDurstenfeldShuffle(stringArray);
